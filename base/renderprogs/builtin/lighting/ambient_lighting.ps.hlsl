...
//	half4 lightProj	=		idtex2Dproj( samp2, fragment.texcoord3 );
	...
	//add toon lambert fos d and s
	diffuseLight = diffuseColor * ( rpDiffuseModifier.xyz * 0.5f ) * toonLambert;
	specularLight = float3( 0.0 ) * toonLambert;

	result.color.xyz = ( ( diffuseLight + specularLight ) *halfLdotN * lightColor + rimLight ) * fragment.color.rgb * 0.25;
